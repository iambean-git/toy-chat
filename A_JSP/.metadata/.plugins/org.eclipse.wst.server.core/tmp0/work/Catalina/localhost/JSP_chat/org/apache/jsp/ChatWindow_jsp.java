 ...
 * Generated at: 2025-03-07 06:46:53 UTC
...
public final class ChatWindow_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	var chatWindow, chatMessage, chatNickname;\r\n");
      out.write("	\r\n");
      out.write("	//채팅창이 열리면 대화창, 메시지 입력창, 대화명 표시란으로 사용할 DOM 객체 저장\r\n");
      out.write("	window.onload = function(){\r\n");
      out.write("		chatWindow = document.getElementById(\"chatWindow\");\r\n");
      out.write("		chatMessage = document.getElementById(\"chatMsg\");\r\n");
      out.write("		chatNickname = document.getElementById(\"chatNickname\").value;\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	// 메시지 전송\r\n");
      out.write("	function sendMessage(){\r\n");
      out.write("		chatWindow.innerHTML += \"<div class='myMsg'>\" + chatMessage.value + \"</div>\";\r\n");
      out.write("		webSocket.send(chatNickname + \"|\" + chatMessage.value);	//서버로 전송\r\n");
      ...
      out.write("		if(window.event.keyCode == 13)	sendMessage();\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	// 웹소켓 서버에 연결됐을 때\r\n");
      out.write("	webSocket.onopen = function(event){\r\n");
      out.write("		chatWindow.innerHTML += \"채팅에 입장하셨습니다.<br/>\";\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	// 웹소켓이 닫혔을 때 or 서버와의 연결이 끊겼을 때\r\n");
      out.write("	webSocket.onclose = function(event){\r\n");
      out.write("		chatWindow.innerHTML += \"채팅에서 퇴장하였습니다.<br/>\";\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	// 에러 발생 시\r\n");
      ...
      out.write("		var msg = event.data.split(\"|\");\r\n");
      out.write("		var sender = msg[0];\r\n");
      out.write("		var content = msg[1];\r\n");
      out.write("		if(content != \"\"){\r\n");
      out.write("			if(content.match(\"/\")){	//귓속말 처리\r\n");
      out.write("				if(content.match(\"/\"+chatNickname)){ // 나에게 보낸 메세지만 출력\r\n");
      out.write("					var temp = content.replace((\"/\"+chatNickname),\"[귓속말] : \");\r\n");
      ...
      out.write("</script>\r\n");
      out.write("<style>\r\n");
      out.write("#chatWindow{border:1px solid #EEEEEE; width:270px; height:310px; overflow:scroll; padding:5px; margin-top:5px; margin-bottom:5px}\r\n");
      out.write("#chatMsg{width:236px; height:20px;}\r\n");
      ...
      out.write("#chatNickname{width:158px; height:24px; border:1px solid #AAAAAA; background-color:#EEEEEE;}\r\n");
      out.write(".myMsg{text-align:right;}\r\n");
      out.write("</style>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      out.write("<body>\r\n");
      out.write("	닉네임 : <input type=\"text\" id=\"chatNickname\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.chatName }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" readonly />\r\n");
      out.write("	<button id=\"closeBtn\" onclick=\"disconnect();\">채팅 종료</button>\r\n");
      out.write("	<div id=\"chatWindow\"></div>\r\n");
      out.write("	<div>\r\n");
      out.write("		<input type=\"text\" id=\"chatMsg\" onkeyup=\"enterKey();\">\r\n");
