...
<script>
	...
	window.onload = function(){
		...
		chatMessage = document.getElementById("chatMsg");
...
<style>
#chatWindow{border:1px solid #EEEEEE; width:270px; height:310px; overflow:scroll; padding:5px; margin-top:5px; margin-bottom:5px}
#chatMsg{width:236px; height:20px;}
